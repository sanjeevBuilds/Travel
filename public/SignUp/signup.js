// Cinematic Snowfall Animation (forest background)
...
class AccumulationSnow {
    ...
    drawFlake(flake, resting) {
        ...
        this.ctx.shadowColor = resting ? '#eaf6ff' : '#7fb069';
...
const inputSnowFullname = new AccumulationSnow(document.getElementById('input-snow-fullname'));
...
const inputSnowConfirm = new AccumulationSnow(document.getElementById('input-snow-confirm'));
const inputSnowSignup = new AccumulationSnow(document.getElementById('input-snow-signup'), { minRadius: 1.1, maxRadius: 2, density: 0.09 });
