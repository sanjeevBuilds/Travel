// Cinematic Snowfall Animation (background remains unchanged)
...
class AccumulationSnow {
    ...
    drawFlake(flake, resting) {
        ...
        this.ctx.shadowColor = resting ? '#eaf6ff' : '#a9c9ff';
...
const inputSnowSource = new AccumulationSnow(document.getElementById('input-snow-source'));
const inputSnowDestination = new AccumulationSnow(document.getElementById('input-snow-destination'));
const inputSnowSearch = new AccumulationSnow(document.getElementById('input-snow-search'), { minRadius: 1.1, maxRadius: 2, density: 0.09 });
